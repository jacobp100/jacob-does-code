export const title = "Super Optimised Static Sites";
...
```markdown
<Image src="/assets/some-image.png" width="auto" height="auto" />
```
...
import { Image } from "jdc/components";
import { classNames } from "jdc/css";
