import { Video } from "jdc";

export const title = "React Native Bottom Sheets";
export const css = ["/assets/blog.css", "/assets/blog-highlight.css"];

# React Native Bottom Sheets

[TechniCalc](/pages/technicalc.mdx) is an advanced scientific and engineering calculator. The UI uses TypeScript and React Native, and the ([open](https://github.com/jacobp100/technicalc-calculator) [source](https://github.com/jacobp100/technicalc-editor)) core is done in ReasonML.
...
<Video
  controls="controls"
  width="300"
  src="/assets/posts/technicalc-bottom-sheet.mp4"
  type="video/mp4"
></Video>
...
const BottomSheetDismissScrollView = (scrollViewProps) => {
  // ...
  const [dismissGestureIsInProgress, setDismissGestureIsInProgress] =
